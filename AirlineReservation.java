...
public class AirlineReservation {
    ...
    private static void initPassengers(String fileName) throws FileNotFoundException 
    {
        ...
        //sort in temp array individually
        String[] temp = scan.nextLine().split(",");
        planeRows = Integer.parseInt(temp[0]);
        firstClassRows = Integer.parseInt(temp[1]);
        businessClassRows = Integer.parseInt(temp[2]);
    ...
    private static int findFirstRow(int travelClass) 
    {
        switch (travelClass)
        {
            ...
            case BUSINESS_CLASS: return firstClassRows;
            case ECONOMY_CLASS: return firstClassRows + businessClassRows;
            default: return -1;
        }
    }
    ...
    private static int findLastRow(int travelClass) 
    {
        switch (travelClass)
        {
            case FIRST_CLASS: return firstClassRows - 1;
            case BUSINESS_CLASS: return firstClassRows + businessClassRows - 1;
            case ECONOMY_CLASS: return planeRows - 1;
            default: return -1;
        }
    }
